...
import { ExternalLink, Clock, Globe, TrendingUp, TrendingDown, Minus, Eye, Newspaper, Activity } from 'lucide-react';
...
const NewsFeed: React.FC = () => {
  ...
  useEffect(() => {
    setIsLoading(true);
    getRecentNews(10).then((data: NewsItem[]) => {
      setNews(data);
      setIsLoading(false);
    });
  }, []);
  ...
  return (
    <div className="bg-gradient-to-br from-neutral-900 to-neutral-800 rounded-2xl shadow-2xl p-8 animate-fade-in border border-neutral-700">
      {/* Enhanced Header */}
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-neutral-400">Real-time market updates and sentiment analysis</p>
          </div>
        </div>
        
        <div className="text-right">
          <div className="text-3xl font-bold text-purple-400">{news.length}</div>
          <div className="text-sm text-neutral-400">Recent Articles</div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bg-gradient-to-br from-green-900/50 to-green-800/50 rounded-xl p-6 border border-green-700/30">
          ...
          <div className="text-sm text-green-300">Positive News</div>
        </div>
        ...
        <div className="bg-gradient-to-br from-gray-900/50 to-gray-800/50 rounded-xl p-6 border border-gray-700/30">
          ...
          <div className="text-sm text-gray-300">Neutral News</div>
        </div>
      ...
      {isLoading ? (
        ...
        <div className="text-center py-12">
          ...
          <p className="text-neutral-500 max-w-md mx-auto">
            No recent news articles found. This could indicate low media coverage or the market being in a quiet period.
          </p>
        </div>
      )}
